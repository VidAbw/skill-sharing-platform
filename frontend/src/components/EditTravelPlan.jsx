...
const EditTravelPlan = () => {
        ...
        const fetchTravelPlan = async () => {
            try {
                ...
                setFormData({
                    ...
                    travelType: planData.travel_type || 'SOLO',
                    budget: planData.budget || '',
                    currency: planData.currency || 'USD',
                    accommodation: planData.accommodation || 'HOTEL',
                    transportationType: planData.transportationType || 'FLIGHT',
                    goals: planData.goals || '',
                    experience: planData.experience || '',
                    culturalInterests: planData.culturalInterests || '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (formData.imageFile) {
                console.log("Adding image file to update:", formData.imageFile.name);
            ...
            if (formData.destinations && formData.destinations.length > 0) {
                submissionData.append('destinations', JSON.stringify(formData.destinations));
            }
            
            if (formData.activities && formData.activities.length > 0) {
                submissionData.append('activities', JSON.stringify(formData.activities));
            }
            ...
            setIsSubmitting(false);
            setError('Failed to update travel plan. Please try again.');
        }
    };
    ...
    // Reuse the same rendering components from TravelPlanForm
                        ...
                        <div className="position-relative" style={{ width: '100px', height: '100px' }}>
                            <img
                                src={formData.imageUrl.startsWith('http') ? 
                                    formData.imageUrl : 
                                    `http://localhost:8000/api/plans/images/${formData.imageUrl}`}
                                alt="Preview"
                ...
                {step < totalSteps ? (
                    ...
                    >
                        {isSubmitting ? (
                            ...
                            <>
                                Update Travel Plan<i className="bi bi-check-circle ms-2"></i>
                            </>
                        )}
                    </button>
                )}
    ...
    if (isLoading) {
        return (
            <div className="container py-5 text-center">
                ...
                <p className="mt-3">Loading travel plan data...</p>
            </div>
        );
    }
                    ...
                    <div className="card shadow-lg border-0">
                        <div className="card-header bg-primary text-white">
                            <div className="d-flex justify-content-between align-items-center">
                                <h4 className="mb-0">Edit Travel Plan</h4>
